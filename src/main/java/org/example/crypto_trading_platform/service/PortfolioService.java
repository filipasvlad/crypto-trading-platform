...
public class PortfolioService {
    ...
    public PortfolioDto addItemToPortfolio(Long userId, String cryptoCurrencyId, Double quantity) {
        Portfolio portfolio = portfolioRepository.findByUserId(userId)
                .orElseThrow(() -> new BadPortfolioRequestException("Portfolio not found for the specified user ID: " + userId));
        ...
        Optional<PortfolioItem> existingPortfolioItem = portfolioItemRepository.findByPortfolio_UserIdAndCryptoCurrencyId(userId, cryptoCurrencyId);
    ...
    public PortfolioDto removeItemFromPortfolio(Long userId, String cryptoCurrencyId, Double quantity) {
        Portfolio portfolio = portfolioRepository.findByUserId(userId)
                .orElseThrow(() -> new BadPortfolioRequestException("Portfolio not found for the specified user ID: " + userId));
    ...
    public List<PortfolioItemDto> getPortfolioItemsByUserId(Long userId) {
        List<PortfolioItem> portfolioItems = portfolioItemRepository.findByPortfolio_UserId(userId);
        return entityListToDtoList(portfolioItems);
    }

    public Optional<PortfolioItem> getPortfolioItem(Long userId, String cryptoCurrencyId) {
        return portfolioItemRepository.findByPortfolio_UserIdAndCryptoCurrencyId(userId, cryptoCurrencyId);
    }
