...
import styles from './SellTransaction.module.css';
...
function SellTransaction() {
    ...
    return (
        <div className={styles.container}>
            <h1 className={styles.title}>Sell {coinSymbol} for USD</h1>
            <p className={styles.exchangeRate}>Exchange rate: 1 {coinSymbol} ≈ {coin.sellPrice} USD</p>
